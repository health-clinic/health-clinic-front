...
import { ProfessionalAppStackScreenProps } from "@/navigators"
...
interface HomeScreenProps extends ProfessionalAppStackScreenProps<"Home"> {}
              ...
              <View className="px-4 gap-4">
                ...
                <View className="p-6 border border-neutral-500 rounded-2xl">
                  ...
                  <Text className="text-zinc-400 text-center mt-2">
                    Aguarde novos agendamentos. Você será notificado quando houver consultas
                    marcadas.
                  </Text>
                </View>
              </View>
